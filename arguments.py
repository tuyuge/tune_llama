...
def add_model_config_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument('--model-config', type=str, default='/data_new/private/tuyuge/results/llama-7b',
...
def add_training_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument('--base-path', type=str, default='llama_adapter',
                       help='Path to the project base directory.')
    group.add_argument('--dataset_name', type=str, default='alpaca',
